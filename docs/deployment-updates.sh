...
#cd /home/neumann/care-bricks/bootstrap-studio-export
...
#cp ../js/*.js assets/js/
rm -rf assets/js
ln -s /home/neumann/care-bricks/js/ assets/js
...
#ln -s /home/neumann/.node-red/flows_s17974030.onlinehome-server.info.json /home/neumann/care-bricks/bootstrap-studio-export/assets/js/node-red-flows.json
